...
void protobuf_AssignDesc_AcesActivity_2eproto() {
  protobuf_AddDesc_AcesActivity_2eproto();
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_AcesActivity_2eproto);
}
...
void protobuf_AddDesc_AcesActivity_2eproto() {
  ...
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_AcesActivity_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_AcesActivity_2eproto {
  StaticDescriptorInitializer_AcesActivity_2eproto() {
    protobuf_AddDesc_AcesActivity_2eproto();
  }
} static_descriptor_initializer_AcesActivity_2eproto_;
...
const MaxSpeedActivity& MaxSpeedActivity::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_AcesActivity_2eproto();
