...
void protobuf_AssignDesc_AceConstants_2eproto() {
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_AceConstants_2eproto);
}
...
void protobuf_AddDesc_AceConstants_2eproto() {
...
struct StaticDescriptorInitializer_AceConstants_2eproto {
  StaticDescriptorInitializer_AceConstants_2eproto() {
    protobuf_AddDesc_AceConstants_2eproto();
  }
