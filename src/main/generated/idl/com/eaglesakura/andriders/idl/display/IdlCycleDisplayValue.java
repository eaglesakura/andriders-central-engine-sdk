...
public class IdlCycleDisplayValue extends com.eaglesakura.android.db.BaseProperties {
    ...
    public void setId(String set){ setProperty("IdlCycleDisplayValue.id", set); }
    public String getId(){ return getStringProperty("IdlCycleDisplayValue.id"); }
    public void setType(String set){ setProperty("IdlCycleDisplayValue.type", set); }
