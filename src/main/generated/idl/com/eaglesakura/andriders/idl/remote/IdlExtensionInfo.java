...
public class IdlExtensionInfo extends com.eaglesakura.android.db.BaseProperties {
    ...
    public IdlExtensionInfo(Context context) {
        super(context, "props.db");
        _initialize();
    }

    public IdlExtensionInfo(Context context, String dbFileName) {
    ...
    public void setText(String set) {
        setProperty("IdlExtensionInfo.text", set);
    }

    public String getText() {
        return getStringProperty("IdlExtensionInfo.text");
    }

    public void setCategory(String set) {
        setProperty("IdlExtensionInfo.category", set);
    }

    public String getCategory() {
        return getStringProperty("IdlExtensionInfo.category");
    }

    public void setHasSetting(boolean set) {
        setProperty("IdlExtensionInfo.hasSetting", set);
    }

    public boolean getHasSetting() {
        return getBooleanProperty("IdlExtensionInfo.hasSetting");
    }
