...
public class IdlExtensionInfo extends com.eaglesakura.android.db.BaseProperties {
    ...
    public static final String ID_ID = "IdlExtensionInfo.id";
    ...
    protected void _initialize() {
        ...
        addProperty("IdlExtensionInfo.id", "");
    ...
    public void setId(String set){ setProperty("IdlExtensionInfo.id", set); }
    public String getId(){ return getStringProperty("IdlExtensionInfo.id"); }
