...
public class IdlHeartrate extends com.eaglesakura.android.db.BaseProperties {
    ...
    public IdlHeartrate(Context context) {
        super(context, "props.db");
        _initialize();
    }

    public IdlHeartrate(Context context, String dbFileName) {
    ...
    public void setBpm(int set) {
        setProperty("IdlHeartrate.bpm", set);
    }

    public int getBpm() {
        return getIntProperty("IdlHeartrate.bpm");
    }
