...
public class IdlStringProperty extends com.eaglesakura.android.db.BaseProperties {
    ...
    public IdlStringProperty(Context context) {
        super(context, "props.db");
        _initialize();
    }

    public IdlStringProperty(Context context, String dbFileName) {
    ...
    public void setValue(String set) {
        setProperty("IdlStringProperty.value", set);
    }

    public String getValue() {
        return getStringProperty("IdlStringProperty.value");
    }
