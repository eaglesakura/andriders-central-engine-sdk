...
public class IdlLocation extends com.eaglesakura.android.db.BaseProperties {
    ...
    public IdlLocation(Context context) {
        super(context, "props.db");
        _initialize();
    }

    public IdlLocation(Context context, String dbFileName) {
    ...
    public void setLatitude(double set) {
        setProperty("IdlLocation.latitude", set);
    }

    public double getLatitude() {
        return getDoubleProperty("IdlLocation.latitude");
    }

    public void setLongitude(double set) {
        setProperty("IdlLocation.longitude", set);
    }

    public double getLongitude() {
        return getDoubleProperty("IdlLocation.longitude");
    }

    public void setAltitude(double set) {
        setProperty("IdlLocation.altitude", set);
    }

    public double getAltitude() {
        return getDoubleProperty("IdlLocation.altitude");
    }

    public void setAccuracyMeter(double set) {
        setProperty("IdlLocation.accuracyMeter", set);
    }

    public double getAccuracyMeter() {
        return getDoubleProperty("IdlLocation.accuracyMeter");
    }
