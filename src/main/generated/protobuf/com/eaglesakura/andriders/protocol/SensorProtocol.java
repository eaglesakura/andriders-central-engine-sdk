...
public final class SensorProtocol {
    ...
    public static final class RawCadence extends
        ...
        private RawCadence(boolean noInit) {
        ...
        public static final class Builder extends
            ...
            public Builder mergeFrom(com.eaglesakura.andriders.protocol.SensorProtocol.RawCadence other) {
                if (other == com.eaglesakura.andriders.protocol.SensorProtocol.RawCadence.getDefaultInstance())
                    return this;
                if (other.hasRpm()) {
                    setRpm(other.getRpm());
                }
    ...
    public static final class RawHeartrate extends
        ...
        private RawHeartrate(boolean noInit) {
            this.unknownFields = com.google.protobuf.UnknownFieldSet.getDefaultInstance();
        }
            ...
            public static HeartrateZone valueOf(int value) {
                switch (value) {
                    ...
                    case 1:
                        return Easy;
                    case 2:
                        return FatCombustion;
                    case 3:
                        return PossessionOxygenMotion;
                    case 4:
                        return NonOxygenatedMotion;
                    case 5:
                        return Overwork;
                    default:
                        return null;
        ...
        public static final class Builder extends
            ...
            public Builder mergeFrom(com.eaglesakura.andriders.protocol.SensorProtocol.RawHeartrate other) {
                if (other == com.eaglesakura.andriders.protocol.SensorProtocol.RawHeartrate.getDefaultInstance())
                    return this;
                if (other.hasBpm()) {
                    setBpm(other.getBpm());
                }
            ...
            /**
             * <code>required .eaglesakura_ace.RawHeartrate.HeartrateZone heartrateZone =
             * 101;</code>
             *
             * <pre>
             * 心拍ゾーン
    ...
    public static final class RawSpeed extends
        ...
        private RawSpeed(boolean noInit) {
            this.unknownFields = com.google.protobuf.UnknownFieldSet.getDefaultInstance();
        }
        ...
        public static final class Builder extends
            ...
            public Builder mergeFrom(com.eaglesakura.andriders.protocol.SensorProtocol.RawSpeed other) {
                if (other == com.eaglesakura.andriders.protocol.SensorProtocol.RawSpeed.getDefaultInstance())
                    return this;
    ...
    public static final class SensorPayload extends
        ...
        private SensorPayload(boolean noInit) {
            this.unknownFields = com.google.protobuf.UnknownFieldSet.getDefaultInstance();
        }
        ...
        public static final class Builder extends
            ...
            public Builder mergeFrom(com.eaglesakura.andriders.protocol.SensorProtocol.SensorPayload other) {
                if (other == com.eaglesakura.andriders.protocol.SensorProtocol.SensorPayload.getDefaultInstance())
                    return this;
                if (other.hasType()) {
